...
|---|---|---|---|---|---|
| 2025-04-01 | 0.00e+00 | 0.0 | 99.0 | 0.00× | 1.58% |
| 2025-04-22 | 1.25e-04 | 90.2 | 98.9 | 8.65× | 1.75% |
...
- bigger-one-ahead score: **0.00013089809749100304**
- cascade 24h expected M≥6: cell lam6 **1.25e-04**, regional **7.50e-04**
- quiet-day 24h: cell lam6 0.00e+00, regional 7.50e-04 → **elevation regional 1.0×**

## (c) PASS criteria (reported as-is, nothing tuned to pass)
- epicenter top decile by lam6: **True** (by seismicity rate: True)
- gain6 > 2× uniform base: **True**
- post-foreshock 24h expected-M6 ≥ 10× quiet: **False**
- **ALL PASS: False**

## (d) secondary cases (+10 min after the trigger)
- Oct2_M5: FTLS UNKNOWN (b_ratio None), 24h P(M≥5.5) cell 0.625%, 24h regional P(M≥6) 0.200%
- Sindirgi_Aug10: FTLS UNKNOWN (b_ratio None), 24h P(M≥5.5) cell 0.000%, 24h regional P(M≥6) 0.947%