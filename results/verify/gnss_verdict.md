# C3 — GNSS v2 channel: VERIFICATION VERDICT = **VOID** (rigorous null)

Claim C3 (from the v2 work): "the trajectory-modelled, step-corrected, common-mode-
filtered gnss_v2 channel carries GENUINE deformation information (+0.061 deconfounded
...
| audit | result | file |
|---|---|---|
| V2a truncated self-test (13 monthly cutoffs + adversarial mid-month) | **bit-for-bit** (dev 0) — causality is clean, no leakage | v2_truncated.json |
| V2c IG bootstrap CI (stationary block, window-ids, B=2000) | test IG +0.098, **95% CI [−0.016, +0.207] INCLUDES 0** | v2_gnss_ig.json |
...
| V2d permutation importance | loads on residual-rate, not the fallback flag — but this is within the noise | v2_gnss_ig.json |
