"""V2(e) — event-level sanity: the top-20 windows where gnss_v2 most increased the
...
def main():
    ...
    L = ["# V2(e) — top-20 windows where gnss_v2 most raised the predicted rate (y30 test)",
