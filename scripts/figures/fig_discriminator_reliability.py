...
def main():
    ...
    rep_cls = json.load(open(OUT / "models" / "synthetic_report.json"))["classifier"]
    print(f"test PR-AUC {pr:.3f}  ROC-AUC {roc:.3f}  "
          f"(report: {rep_cls['test_pr_auc']:.3f} / {rep_cls['test_roc_auc']:.3f})")
