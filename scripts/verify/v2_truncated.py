"""V2(a) — gnss_v2 truncated self-test at >=12 monthly cutoffs across 2024-2026
...
Writes results/verify/v2_truncated.json.
"""
import json
import numpy as np
import pandas as pd
...
def main():
    ...
    if not ok:
        json.dump({"skipped": why}, open(VER / "v2_truncated.json", "w"), indent=2)
    ...
    json.dump(out, open(VER / "v2_truncated.json", "w"), indent=2)
