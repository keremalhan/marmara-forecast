"""Phase D1 verdict — dense_catalog: (1) truncated self-test bit-for-bit (causality),
(2) block-bootstrap CI on the aug-vs-base test IG. Promotion rule: val IG>+0.02 AND
test IG>0. Writes results/verify/d1_dense_verdict.json.
"""
import json
import numpy as np
import pandas as pd
...
def main():
    ...
    json.dump(out, open(VER / "d1_dense_verdict.json", "w"), indent=2)
